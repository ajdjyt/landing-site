...
<div class="md:max-w-[85%] mx-auto w-full flex flex-col md:flex-row min-h-screen md:space-x-3 px-4 z-20 items-center justify-center ">
	<div class="max-w-[85%] h-[45vh]  md:h-auto flex flex-col md:gap-10 space-y-3 md:flex-1 items-center justify-end pb-14 ">
		<h2
	...
	<div class="md:min-w-1/2 w-screen flex-1 items-center justify-center md:pb-10 pb-14 flex flex-col">
