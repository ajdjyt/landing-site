...
<SectionWrapper id="query">
	<div class="flex flex-col mb-12 items-center justify-center">
		...
		<form class="flex flex-col w-full md:w-1/2 md:w-[35rem] items-center" method="post" on:submit={handleSubmit}>
			...
			<button
				type="submit"
				class="text-white md:w-[20rem] bg-emColor hover:bg-emColorAlt focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center"
				>Submit</button
			>
		</form>
